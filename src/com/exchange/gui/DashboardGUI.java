...
public class DashboardGUI extends javax.swing.JFrame implements Runnable {
	...
	private void initComponents() throws ClassNotFoundException, IOException {
								...
								.addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(layout.createSequentialGroup().addComponent(jLabel16)
														.addGap(38, 38, 38).addComponent(ethereumWallet)
														.addContainerGap())
												.addGroup(layout
														...
														.addGroup(layout
																...
																.addGroup(layout.createSequentialGroup()
																		.addGap(213, 213, 213).addComponent(convert)))
														.addPreferredGap(
														...
														.addGroup(layout
																...
																.addGroup(layout.createSequentialGroup().addGroup(layout
																		...
																		.addContainerGap())
																.addGroup(layout.createSequentialGroup()
																		.addGap(92, 92, 92).addComponent(schedule)
																		.addGap(43, 43, 43).addComponent(autoSchedule)
																		.addPreferredGap(
																				javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																				javax.swing.GroupLayout.DEFAULT_SIZE,
																				Short.MAX_VALUE)
																		.addComponent(alerts).addGap(29, 29, 29))))))
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(transaction))
								.addGroup(layout.createSequentialGroup().addGap(536, 536, 536).addComponent(jLabel21)
										.addGap(34, 34, 34).addComponent(roi)))
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(20, 20, 20).addComponent(jLabel13).addGap(18, 18, 18)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1).addComponent(bitcoinPrice).addComponent(bitcoinBuy)
								.addComponent(bitcoinSell).addComponent(jLabel8).addComponent(bitcoinChange))
						.addGap(52, 52, 52)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel3).addComponent(ethereumPrice).addComponent(ethereumBuy)
								.addComponent(ethereumSell).addComponent(jLabel7).addComponent(ethereumChange))
						.addGap(63, 63, 63)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel2).addComponent(litecoinPrice).addComponent(litecoinBuy)
								.addComponent(litecoinSell).addComponent(jLabel9).addComponent(litecoinChange))
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addGap(67, 67, 67)
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(ethereumWallet).addComponent(jLabel16)))
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel21).addComponent(roi))
						.addGap(18, 18, 18).addComponent(paymentMethod).addGap(36, 36, 36)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(transaction).addComponent(convert).addComponent(schedule)
								.addComponent(alerts).addComponent(autoSchedule))
						.addGap(40, 40, 40)));
